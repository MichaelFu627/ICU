...
```{r}
data_3_admi <- read_csv("MIMIC-3/ADMISSIONS.csv")
data_3_ICU <- read.csv("MIMIC-3/ICUSTAYS.csv")
data_3_Patient <- read_csv("MIMIC-3/PATIENTS.csv")
data_3_diag_ICD <- read.csv("MIMIC-3/DIAGNOSES_ICD.csv")
data_3_ICD <- read_csv("MIMIC-3/D_ICD_DIAGNOSES.csv") 
```
